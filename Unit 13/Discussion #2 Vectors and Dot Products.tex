\begin{itemize}
    ...
    \item A scalar is a measure of a physical quantity determined solely by it's magnitude, while the dot product is the work done by a force and distance vector.
\end{itemize}
